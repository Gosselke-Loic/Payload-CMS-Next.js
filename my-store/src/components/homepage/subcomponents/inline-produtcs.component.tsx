import { InlineProducts } from "@/shared";
...
export default function InlineProductsComponent({data}: Props) {
    ...
    return (
        <>
            <Title className="ml-6 max-sm:mt-4 max-sm:text-2xl max-sm:text-center">
                { data.principalTitle ?? "Our recomendations" }
            </Title>
            <Carousel 
                slideSize="25%"
                align="start"
